...
public protocol FSPagerViewDataSource: NSObjectProtocol {
    ...
    func numberOfItems(in pagerView: MPagerView) -> Int
    ...
    func pagerView(_ pagerView: MPagerView, cellForItemAt index: Int) -> FSPagerViewCell
...
public protocol FSPagerViewDelegate: NSObjectProtocol {
    ...
    optional func pagerView(_ pagerView: MPagerView, shouldHighlightItemAt index: Int) -> Bool
    
    /// Tells the delegate that the item at the specified index was highlighted.
    @objc(pagerView:didHighlightItemAtIndex:)
    optional func pagerView(_ pagerView: MPagerView, didHighlightItemAt index: Int)
    
    /// Asks the delegate if the specified item should be selected.
    @objc(pagerView:shouldSelectItemAtIndex:)
    optional func pagerView(_ pagerView: MPagerView, shouldSelectItemAt index: Int) -> Bool
    
    /// Tells the delegate that the item at the specified index was selected.
    @objc(pagerView:didSelectItemAtIndex:)
    optional func pagerView(_ pagerView: MPagerView, didSelectItemAt index: Int)
    ...
    optional func pagerView(_ pagerView: MPagerView, willDisplay cell: FSPagerViewCell, forItemAt index: Int)
    ...
    optional func pagerView(_ pagerView: MPagerView, didEndDisplaying cell: FSPagerViewCell, forItemAt index: Int)
    
    /// Tells the delegate when the pager view is about to start scrolling the content.
    @objc(pagerViewWillBeginDragging:)
    optional func pagerViewWillBeginDragging(_ pagerView: MPagerView)
    
    /// Tells the delegate when the user finishes scrolling the content.
    @objc(pagerViewWillEndDragging:targetIndex:)
    optional func pagerViewWillEndDragging(_ pagerView: MPagerView, targetIndex: Int)
    
    /// Tells the delegate when the user scrolls the content view within the receiver.
    @objc(pagerViewDidScroll:)
    optional func pagerViewDidScroll(_ pagerView: MPagerView)
    
    /// Tells the delegate when a scrolling animation in the pager view concludes.
    @objc(pagerViewDidEndScrollAnimation:)
    optional func pagerViewDidEndScrollAnimation(_ pagerView: MPagerView)
    
    /// Tells the delegate that the pager view has ended decelerating the scrolling movement.
    @objc(pagerViewDidEndDecelerating:)
    optional func pagerViewDidEndDecelerating(_ pagerView: MPagerView)
    
}

@IBDesignable
open class MPagerView: UIView,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    @objc
    open var scrollDirection: MPagerView.ScrollDirection = .horizontal {
        didSet {
