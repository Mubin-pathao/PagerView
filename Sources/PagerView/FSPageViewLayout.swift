...
class FSPagerViewLayout: UICollectionViewLayout {
    ...
    internal var scrollDirection: MPagerView.ScrollDirection = .horizontal
    
    open override class var layoutAttributesClass: AnyClass {
        return FSPagerViewLayoutAttributes.self
    }
    
    fileprivate var pagerView: MPagerView? {
        return self.collectionView?.superview?.superview as? MPagerView
    }
    ...
    override open func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        func calculateTargetOffset(by proposedOffset: CGFloat, boundedOffset: CGFloat) -> CGFloat {
            ...
            if pagerView.decelerationDistance == MPagerView.automaticDistance {
